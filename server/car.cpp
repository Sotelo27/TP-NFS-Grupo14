...
Car::Car(std::string modelo, uint16_t base_speed, uint16_t base_acceleration, uint16_t base_mass,
...
Position Car::get_Pose() const noexcept { return Position{pos_X, pos_Y}; }

...
namespace car_factory {
    ...
    inline CarModel common_green_car()      { return {"green",      1250.f, 250.f, 8.0f,  5.2f, 0.72f, 5.5f}; }
    inline CarModel red_car()      { return {"red_car",      1100.f, 270.f, 9.0f,  5.6f, 0.68f, 5.0f}; }
    inline CarModel red_sport_car()  { return {"red_sport_car",  1050.f, 300.f, 9.5f,  6.2f, 0.66f, 4.8f}; }
